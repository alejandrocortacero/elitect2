...
<?php if( class_exists( 'JLCContact' ) ) : ?>
	<div class="centered-layer">
		...
		<?php if( empty( $addresses_list ) ) : ?>
			<?php echo JLCContact::get_contact_phone_link( sprintf( '<h3 class="text-center">%s</h3><h3 class="text-center phone"><span class="glyphicon glyphicon-earphone"></span> {phone}</h3>', __( 'Call us', TrainerSiteTheme::TEXT_DOMAIN ) ) ); ?>
		<?php else : ?>
