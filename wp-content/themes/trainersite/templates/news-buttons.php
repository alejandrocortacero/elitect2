...
<a class="social-link"
	...
	title="<?php echo $title = esc_attr( __( 'Read news', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
...
<a class="social-link"
	...
	aria-label="<?php echo $title = esc_attr( __( 'Comments', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
...
<a class="social-link"
	...
	aria-label="<?php echo $title = esc_attr( __( 'Share by mail', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
>
...
<a class="social-link"
	...
	aria-label="<?php echo $title = esc_attr( __( 'Share on Twitter', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
	target="_blank"
>
	<span class="fa fa-twitter"></span>
</a>
<?php if( $facebook_api_id = TrainerSiteTheme::get_facebook_app_id() ) : ?>
<a class="social-link"
	rel="nofollow"
	...
	aria-label="<?php echo $title = esc_attr( __( 'Share on Facebook', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
	target="_blank"
>
...
<a
	class="social-link"
	rel="nofollow"
	aria-label="<?php echo $title = esc_attr( __( 'Share on Google +', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
...
<a class="social-link"
	rel="nofollow"
	aria-label="<?php echo $title = esc_attr( __( 'Share on Whatsapp', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
...
<a class="social-link"
	rel="nofollow"
	aria-label="<?php echo $title = esc_attr( __( 'Share on LinkedIn', TrainerSiteTheme::TEXT_DOMAIN ) ); ?>"
	title="<?php echo $title; ?>"
