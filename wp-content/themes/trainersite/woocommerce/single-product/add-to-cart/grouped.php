					...
					switch ( $column_id ) {
						case 'quantity':
							...
							if ( ! $grouped_product_child->is_purchasable() || $grouped_product_child->has_options() || ! $grouped_product_child->is_in_stock() ) {
								...
								echo '<input type="checkbox" name="' . esc_attr( 'quantity[' . $grouped_product_child->get_id() . ']' ) . '" value="1" class="wc-grouped-product-add-to-cart-checkbox cool" id="cool-quantity-checkbox-' . $grouped_product_child->get_id() . '" /><label for="cool-quantity-checkbox-' . $grouped_product_child->get_id() . '"><span class="checker"></span></label>';
							} else {
