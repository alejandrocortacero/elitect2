...
<div class="container">
	<div class="row">
		<div class="col-xs-12 page-content site-style-content">
			<h1 class="cool-heading"><?php echo esc_html( __( 'Site Style', TrainerSiteTheme::TEXT_DOMAIN ) ); ?></h1>
			<?php echo TrainerSiteTheme::get_site_style_form(); ?>
		</div>
	</div>
</div>
<?php endif; ?>
