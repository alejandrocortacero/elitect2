...
class TrainerSiteThemeFacebook
{
	const FACEBOOK_APP_ID_KEY = 'trainersite_facebook_app_id';
	const ENABLE_LIKE_BUTTON_SUPPORT_KEY = 'trainersite_facebook_enable_like_button';
	...
	public static function initialize()
	{
		...
		add_action( 'trainersitetheme_footer_after_static_content', array( get_class(), 'print_footer_tags' ), 90, 0 );
	}
	...
	public static function settings_fields( $fields )
	{
		$fields[] = array(
			...
			'args' => array(
				...
				'label' => __( 'Facebook app ID', TrainerSiteTheme::TEXT_DOMAIN ),
				'required' => false
			)
		);
		...
		$fields[] = array(
			...
			'args' => array(
				'value' => 'yes',
				'label' => __( 'Enable Facebook like button support', TrainerSiteTheme::TEXT_DOMAIN ),
	...
	public static function get_og_title()
	{
		...
		// If it's a search, use a dynamic search results title.
			...
			$title['title'] = get_bloginfo( 'name', 'display' ) . ' - ' . __( 'Catalog', TrainerSiteTheme::TEXT_DOMAIN );
