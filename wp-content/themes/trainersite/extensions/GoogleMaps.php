...
class TrainerSiteThemeGoogleMaps
{
	const API_KEY_KEY = 'trainersite_google_maps_api_key';
	...
	public static function settings_fields( $fields )
	{
		$fields[] = array(
			'type' => 'heading',
			'args' => array(
				'content' => __( 'Google Maps', TrainerSiteTheme::TEXT_DOMAIN ),
				'size' => 2
			)
		);
		...
		$fields[] = array(
			...
			'args' => array(
				...
				'label' => __( 'Google Maps API key', TrainerSiteTheme::TEXT_DOMAIN ),
				'help' => __( 'Leave blank if another source is inserting and managing Google Maps scripts', TrainerSiteTheme::TEXT_DOMAIN ),
				'required' => false
			)
		);
