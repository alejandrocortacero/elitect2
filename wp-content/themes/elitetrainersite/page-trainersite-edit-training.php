				...
				<div class="exercise">
					...
					<div class="form-group exercise-type-form-group">
						<select class="form-control exercise-type-select-input">
							<option value="preset" <?php if( !$t_ex->trainer ) : ?>selected="selected"<?php endif; ?>>Predefinidos</option>
							<option value="own" <?php if( $t_ex->trainer ) : ?>selected="selected"<?php endif; ?>>Propios</option>
						</select>
					</div>
					<div class="form-group select-form-group">
						<select class="form-control exercise-select-input exercise-select-input-preset <?php if( !$t_ex->trainer ) : ?>active-selector<?php endif; ?>">
						...
						<select class="form-control exercise-select-input exercise-select-input-own <?php if( $t_ex->trainer ) : ?>active-selector<?php endif; ?>">
						<?php foreach( $exercises_in_category as $ex ) : ?>
							<?php if( $ex->trainer ) : ?>
							<option
								value="<?php echo esc_attr( $ex->ID ); ?>"
...
<?php endforeach; ?>
		...
		<div class="col-xs-12">
			...
			<div class="add-training-layer form-group">
				...
				<div class="checkbox" <?php if( !$training && !$member_id ) : ?>style="display:none;"<?php endif; ?>>
