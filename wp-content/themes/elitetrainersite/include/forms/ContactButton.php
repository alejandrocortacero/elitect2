...
class JLCContactButtonForm extends JLCLinkAbstractForm
{
	public function __construct( $internal_id, $args )
	{
		...
		$this->button_selector = '.contact-container .link-layer .link a .text-inner';
	}
}
