...
if( !class_exists( 'JLCOnlinePlanFeaturesForm' ) )
{

class JLCOnlinePlanFeaturesForm extends JLCCustomForm
{
	public function __construct( $internal_id, $args )
	{
		...
		parent::__construct(
			...
			$internal_id,
			$text_domain,
			'elite_trainer_site_online_plan_features',
			true,//ajax
	...
	{
		wp_enqueue_script(
			'elite-trainer-theme-update-online-plan-features',
			get_template_directory_uri() . '/js/readevents/online-plan-features.js',
			array( 'jquery' ),
	...
	protected function process_form()
	{
		...
		$response = new WP_Ajax_Response( array(
			...
			'data' => json_encode( array(
				'name' => 'eliteTrainerThemeUpdateOnlineFeaturesText',
				'args' => array(
					'onlineFeaturesText' => EliteTrainerSiteThemeCustomizer::get_online_plan_features()
				)
			) )
		) );
		$response->send();
