...
if( !class_exists( 'JLCOnlinePlanPageSubtitleForm' ) )
{

if( !class_exists( 'JLCTextAbstractForm' ) )
	require_once( implode( DIRECTORY_SEPARATOR, array( __DIR__, 'TextAbstract.php' ) ) );

class JLCOnlinePlanPageSubtitleForm extends JLCTextAbstractForm
{
	public function __construct( $internal_id, $args )
	{
		parent::__construct(
			...
			$args,
			null,//form_title
			'Tu entrenamiento siempre disponible',//default_text,
