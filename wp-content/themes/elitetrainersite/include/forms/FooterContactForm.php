...
if( !class_exists( 'JLCFooterContactFormForm' ) )
{

class JLCFooterContactFormForm extends JLCCustomForm
{
	public function __construct( $internal_id, $args )
	{
		...
		parent::__construct(
			...
			$internal_id,
			$text_domain,
			'elite_trainer_site_footer_contact_form',
			true,//ajax
		...
		$color_field = $this->add_color_field(
			'color',
			array(
				'value' => EliteTrainerSiteThemeCustomizer::get_footer_contact_form_text_color(),
				'label' => __( 'Color de texto', $this->get_text_domain() ),
				'required' => true
			)
		);
		$color_field->set_datalist( EliteTrainerSiteThemeCustomizer::get_option_history( EliteTrainerSiteThemeCustomizer::FOOTER_CONTACT_FORM_TEXT_COLOR_KEY ) );

		$bg_color_field = $this->add_background_field(
			'bgcolor',
			array(
				'value' => EliteTrainerSiteThemeCustomizer::get_footer_contact_form_bg(),
		...
		$font_size_field = $this->add_number_field(
			'fontsize',
			array(
				'value' => EliteTrainerSiteThemeCustomizer::get_footer_contact_form_font_size(),
		...
		$font_size_field->set_datalist( EliteTrainerSiteThemeCustomizer::get_option_history( EliteTrainerSiteThemeCustomizer::FOOTER_CONTACT_FORM_FONT_SIZE_KEY ) );

		$font_family = EliteTrainerSiteThemeCustomizer::get_footer_contact_form_font_family();
...
*/
	protected function process_form()
	{
		...
		EliteTrainerSiteThemeCustomizer::set_footer_contact_form_text_color( $color );

		$bg = $this->get_field_by_name( 'bgcolor' )->get_value();
		EliteTrainerSiteThemeCustomizer::set_footer_contact_form_bg( $bg );
		
		$fontsize = $this->get_field_by_name( 'fontsize' )->get_value();
		EliteTrainerSiteThemeCustomizer::set_footer_contact_form_font_size( $fontsize );

		$fontfamily = $this->get_field_by_name( 'fontfamily' )->get_value();
		EliteTrainerSiteThemeCustomizer::set_footer_contact_form_font_family( $fontfamily );
