...
class EliteTrainerSiteThemeLazyLoad
{
	const LAZY_LOAD_ACTION = 'elitetrainersite_lazy_load';
	...
	{
		$version = EliteTrainerSiteTheme::get_version();

		wp_enqueue_script( 'elitetrainersite-lazy-js', get_template_directory_uri() . '/js/lazy.js', array( 'jquery' ), $version, true );

		wp_localize_script( 'elitetrainersite-lazy-js', 'EliteTrainerSiteLazy', array(
