...
$objective = $objective_id && class_exists( 'EpointPersonalTrainerMapper', false ) ? EpointPersonalTrainerMapper::get_diet_objective( $objective_id ) : null;
			...
			<div class="col-xxs-12 col-xs-12">
				<div class="row">
					...
					<?php if( class_exists( 'EpointPersonalTrainer', false ) ) : ?>
						...
						<?php echo EpointPersonalTrainerPublic::get_edit_diet_objective_form( $objective_id ); ?>
