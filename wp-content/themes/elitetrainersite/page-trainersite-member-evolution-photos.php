	...
	<?php if( $member && have_posts() ) : the_post(); ?>
		<div class="row">
			<div class="col-xxs-12 col-xs-12">
				<h1><a class="btn btn-primary pull-right" href="<?php echo EliteTrainerSiteTheme::get_my_account_url(); ?>">Volver al perfil</a> Mis evolución en fotos</h1>
...
<?php if( class_exists( 'EpointPersonalTrainer', false ) &&
			...
			empty( EpointPersonalTrainerMapper::get_user_evolution_photos( get_current_user_id() ) )
			 ) : ?>
	<?php get_template_part( 'templates/first-modals/member', 'photos' ); ?>
<?php endif; ?>
