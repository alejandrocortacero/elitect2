	...
	<?php if( $member && have_posts() ) : the_post(); ?>
		<div class="row">
			<div class="col-xxs-12 col-xs-12">
				<h1><a class="btn btn-primary pull-right" href="<?php echo EliteTrainerSiteTheme::get_edit_member_url( $member_id ); ?>">Volver al perfil</a> Medidas corporales de <?php echo esc_html( $member->display_name ); ?></h1>
				<div class="row corporal-measures-row">
					<div class="col-xs-12">
						<div class="section-text">
							...
							<?php EliteTrainerSiteThemeCustomizer::print_edit_button( 'corporalmeasuresheadertext' ); ?>
						</div>
...
<table class="table table-striped">
	...
	<?php endforeach; ?>
					...
					<hr />
					<?php echo EpointPersonalTrainerPublic::get_member_corporal_measures_form( $member_id, $trainer_id ); ?>
