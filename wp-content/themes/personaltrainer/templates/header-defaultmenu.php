...
<?php foreach( PersonalTrainerTheme::get_default_menu_items() as $item ) : ?>
	<?php if( empty( $item['children'] ) ) : ?>
		<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home" style="display: none;"><a href="<?php echo esc_url( $item['url'] ); ?>" aria-label="<?php echo esc_attr( $item['text'] ); ?>">
