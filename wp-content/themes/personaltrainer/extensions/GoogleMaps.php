...
class PersonalTrainerThemeGoogleMaps
{
	const API_KEY_KEY = 'personaltrainer_google_maps_api_key';
	...
	public static function settings_fields( $fields )
	{
		$fields[] = array(
			'type' => 'heading',
			'args' => array(
				'content' => __( 'Google Maps', PersonalTrainerTheme::TEXT_DOMAIN ),
				'size' => 2
			)
		);
		...
		$fields[] = array(
			...
			'args' => array(
				...
				'label' => __( 'Google Maps API key', PersonalTrainerTheme::TEXT_DOMAIN ),
				'help' => __( 'Leave blank if another source is inserting and managing Google Maps scripts', PersonalTrainerTheme::TEXT_DOMAIN ),
				'required' => false
			)
		);
