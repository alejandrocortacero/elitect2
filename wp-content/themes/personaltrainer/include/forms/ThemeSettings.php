...
if( !class_exists( 'JLCThemeSettingsForm' ) )
{
...
class JLCThemeSettingsForm extends JLCAdminSettingsForm
{
...
*/
		$this->add_post_select(
			PersonalTrainerTheme::TRAINER_LANDING_PAGE_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::TRAINER_LANDING_PAGE_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'publish'
				),
				'label' => __( 'Trainer landing page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_post_select(
			PersonalTrainerTheme::SPORTSMAN_LANDING_PAGE_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::SPORTSMAN_LANDING_PAGE_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'publish'
				),
				'label' => __( 'Sportsman landing page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_post_select(
			PersonalTrainerTheme::SUPERTRAINER_PAGE_GENERAL_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::SUPERTRAINER_PAGE_GENERAL_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'private'
				),
				'label' => __( 'Supertrainer genereal page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_post_select(
			PersonalTrainerTheme::SUPERTRAINER_PAGE_TRAINING_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::SUPERTRAINER_PAGE_TRAINING_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'private'
				),
				'label' => __( 'Supertrainer training page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_post_select(
			PersonalTrainerTheme::SUPERTRAINER_PAGE_EXERCISES_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::SUPERTRAINER_PAGE_EXERCISES_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'private'
				),
				'label' => __( 'Supertrainer exercises page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_post_select(
			PersonalTrainerTheme::SUPERTRAINER_PAGE_TRAINERS_KEY,
			array(
				'preselected' => get_option( PersonalTrainerTheme::SUPERTRAINER_PAGE_TRAINERS_KEY, array() ),
				'query_args' => array(
					'numberposts' => -1,
					'post_type' => 'page',
					'post_status' => 'private'
				),
				'label' => __( 'Supertrainer trainers page', $this->get_text_domain() ),
				'required' => false
			)
		);

		$this->add_fields_from_array( apply_filters( 'personaltrainer_settings_form_fields', array() ) );
