...
$cfg['blowfish_secret']					= 'eF&I9\"CRiVZEo^N8EBB1]<a|sSI2/I<)' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_T6M0hxqS3NB4igQ1I28AJsD/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://www.eliteclubtrainingtest.es/wp-admin/?rand=86635576&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://www.eliteclubtrainingtest.es/wp-admin/?rand=97042395&pma_logout=1';
