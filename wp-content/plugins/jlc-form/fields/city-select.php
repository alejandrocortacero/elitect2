...
if( !class_exists( 'JLCCustomFormCitySelectField' ) )
{
...
/**
 * Pendiente de completar e incluir en jlc-form y FieldLoader
*/
class JLCCustomFormCitySelectField extends JLCCustomFormSelectField
{
	public function __construct(
		...
		$this->load_cities( $countries, $states );
	}
	...
	public static function get_countries()
	{
		...
		{
			global $wpdb;
			$table_name = $wpdb->base_prefix . 'jlc_custom_form_countries';
			return $wpdb->get_results( "SELECT * FROM $table_name" );
		}
		else
		{
			include( implode( DIRECTORY_SEPARATOR, array( __DIR__, 'geography', 'countries.php' ) ) );
			return $countries;
		}
	}
