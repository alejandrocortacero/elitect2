...
<div class="form-group form-group-<?php echo esc_attr( $this->get_name() ); ?>">
	...
	<input
		...
		<?php if( is_integer( $this->get_max() ) ) :?>max="<?php echo $this->get_max(); ?>"<?php endif; ?>
		<?php if( is_integer( $this->get_min() ) ) :?>min="<?php echo $this->get_min(); ?>"<?php endif; ?>
		<?php if( is_numeric( $this->get_step() ) ) :?>step="<?php echo $this->get_step(); ?>"<?php endif; ?>
