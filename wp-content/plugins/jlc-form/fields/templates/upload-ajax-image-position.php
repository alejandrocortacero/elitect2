...
<div class="jlc-custom-form-upload-ajax-image-field jlc-custom-form-upload-ajax-image-position-field <?php if( !empty( $this->get_value() ) ) : ?>set<?php endif; ?> <?php if( $this->is_for_portrait() ) : ?>for-portrait<?php endif; ?>">
...
<?php if( false ) : ?>
		...
		/>
<?php endif; ?>
		<div class="jlc-custom-form-upload-ajax-image-field-img-layer" <?php if( true ) : ?>style="background-image:url('<?php echo $this->get_selector_image_url(); ?>'); background-position:<?php echo $this->get_image_x(); ?>% <?php echo $this->get_image_y(); ?>%;" data-image-width="<?php echo $this->get_selector_image_width(); ?>" data-image-height="<?php echo $this->get_selector_image_height(); ?>"<?php endif; ?>>
<?php if( false ) : ?>
			<img
				alt="<?php echo esc_attr( __( 'Selected image', JLCCustomForm::TEXT_DOMAIN ) ); ?>"
				src="<?php echo $this->get_selector_image_url(); ?>"
...
<?php endif; ?>
		...
		>
			...
			<button class="jlc-custom-form-move-image move-left" data-to="left"><span class="glyphicon glyphicon-arrow-left"></span></button>
			<button class="jlc-custom-form-move-image move-right" data-to="right"><span class="glyphicon glyphicon-arrow-right"></span></button>
			<button class="jlc-custom-form-move-image move-up" data-to="up"><span class="glyphicon glyphicon-arrow-up"></span></button>
			<button class="jlc-custom-form-move-image move-down" data-to="down"><span class="glyphicon glyphicon-arrow-down"></span></button>
	</div>
