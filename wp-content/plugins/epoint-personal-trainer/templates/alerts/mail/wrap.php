...
<body style="background-color:#FFFFFF;">
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#F6F6F6; color:#111111;">
		<?php if( $logo_url ) : ?>
		<tr>
			<td style="padding:30px;color:#000000;background-color:#F6F6F6;text-align:center;"><img style="width:160px;height:auto;margin-left:auto;margin-right:auto;display:block;" src="<?php echo esc_attr( $logo_url ); ?>" /></td>
		</tr>
		<?php endif; ?>
		<tr>
