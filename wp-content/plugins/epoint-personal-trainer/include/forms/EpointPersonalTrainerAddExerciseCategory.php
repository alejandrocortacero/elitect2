...
if( !class_exists( 'JLCEpointPersonalTrainerAddExerciseCategoryForm' ) )
{

class JLCEpointPersonalTrainerAddExerciseCategoryForm extends JLCCustomForm
{
	public function __construct( $internal_id, $args )
	{
		...
		parent::__construct(
			...
			$internal_id,
			$text_domain,
			'epoint_personal_trainer_add_exercise_category',
			true,//ajax
	...
	protected function process_form()
	{
		...
		$new_id = EpointPersonalTrainerMapper::create_exercise_category( $name, 1, true, get_current_user_id() );

		if( $new_id )
		{
			setCookie( 'exercises_gallery_message', 'Categoría creada satisfactoriamente', time() + 24*60*60*1000, '/' );
